...
5. **실거래 시세** (③결과) — 동일단지/유사물건 비교표 + 보수/중립/낙관
6. **수익 분석** (③결과) — 낙찰가 시나리오별 8대 비용 손익표 + 권장 낙찰상한
7. **종합 판단** — 권리/수익/리스크 Council 카드 → GO/조건부/보류
8. **입찰 전 체크리스트** — 등기부·전입세대열람·관리비·현장·수리
9. **부록** — 사용 리소스 + 분석 메트릭(소요시간·추정 토큰·추정비용 입력$3/출력$15 per 1M, 환율 1,400원) + 면책
